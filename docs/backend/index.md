...
Backend del módulo **BackOffice** de la Plataforma Gamificada. Stack: **Java 21 · Spring Boot 3 · Maven** · Microservicios · RabbitMQ · PostgreSQL.
...
| [Comunicación](/backend/arquitectura/comunicacion) | Service Discovery (Eureka), REST + RabbitMQ, Outbox, idempotencia |
