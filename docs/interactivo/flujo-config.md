...
El patrón **híbrido** de mensajería: REST por el gateway para la operación + **Kafka** + **caché con TTL** para propagar el cambio a los consumidores (Temas 03/05/08/10), sin que la respuesta al ADMIN dependa de la propagación.
